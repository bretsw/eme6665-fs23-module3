...
[bretsw.com/eme6665-fs23-module3](https://bretsw.com/eme6665-fs23-module3)
...
3. **Handbook Chapters (Module 3):** [Search FSU Libraries](https://fsu-flvc.primo.exlibrisgroup.com/discovery/search?query=genre,exact,Handbooks,%20manuals,%20etc,AND&tab=Everything&search_scope=MyInst_and_CI&vid=01FALSC_FSU:Home&mode=advanced&offset=0)
...
1. Wikipedia: [wikipedia.org](https://www.wikipedia.org/)

--

2. ChatGPT: [chat.openai.com](https://chat.openai.com/) or Google Bard: [bard.google.com](https://bard.google.com/chat)
